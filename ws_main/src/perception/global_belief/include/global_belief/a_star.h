#ifndef GLOBAL_BELIEF_A_STAR_H_
#define GLOBAL_BELIEF_A_STAR_H_
...
namespace gb_astar
{
	...
	{
	private:
		global_belief::MapManager::Ptr map_;
	...
	public:
		 ...
		 */
		void initAstar(global_belief::MapManager::Ptr map, const Eigen::Vector3i pool_size);
